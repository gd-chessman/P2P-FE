...
export const me = async () => {
    try {
        const temp = await axiosClient.post(`/auth/me`);
        return temp.data;
    } catch (e) {
        return {};
    }
...
export const updateProfile = async (item: any) => {
    try {
        const temp = await axiosClient.post(`/auth/update-profile`, item);
        return temp.data;
    } catch (e) {
        throw e;
    }
...
export const updateAvatar = async (item: any) => {
    try {
        const temp = await axiosClient.post(`/auth/update-avatar`, item);
        return temp.data;
    } catch (e) {
        throw e;
    }
